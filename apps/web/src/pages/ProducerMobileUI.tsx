...
export function ProducerMobileUI() {
  ...
  if (loading) {
    return <div className="page-empty">Loading producer interface…</div>
  }
  ...
  return (
    <div className="stack-lg">
      <section className="panel hero-panel">
        <div>
          <div className="badge-roadmap">Producer mobile UI</div>
          <h1 className="page-title">Mobile-first capture workflow</h1>
          <p className="page-subtitle">
            Wallet-free demo experience with guided DPP capture, NFC simulation, and context-aware telemetry tasks.
          </p>
        </div>
      ...
      <section className="two-column-grid">
        ...
        <div className="panel">
          <div className="section-title-row">
            <h2>NFC simulation</h2>
            <span className="badge-roadmap">No hardware required</span>
          </div>
